...
export interface ApiBannerBanner extends Schema.CollectionType {
  ...
  attributes: {
    bannerText: Attribute.String & Attribute.Required;
...
export interface ApiDroneUseDroneUse extends Schema.CollectionType {
  collectionName: 'drone_uses';
  info: {
    singularName: 'drone-use';
    pluralName: 'drone-uses';
    displayName: 'Drone Use';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    droneUse: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::drone-use.drone-use',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiPhilosophyAndMissionPhilosophyAndMission
  extends Schema.SingleType {
  collectionName: 'philosophy_and_missions';
  info: {
    singularName: 'philosophy-and-mission';
    pluralName: 'philosophy-and-missions';
    displayName: 'Philosophy And Mission';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::philosophy-and-mission.philosophy-and-mission',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    images: Attribute.Relation<
      ...
      'api::image.image'
    >;
    backgroundImage: Attribute.Relation<
      'api::project.project',
      'oneToOne',
      'api::image.image'
    >;
    youtubeVideos: Attribute.Relation<
      'api::project.project',
      'oneToMany',
...
export interface ApiQuoteInfoQuoteInfo extends Schema.SingleType {
  collectionName: 'quote_infos';
  info: {
    singularName: 'quote-info';
    pluralName: 'quote-infos';
    displayName: 'Quote Info';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    image: Attribute.Relation<
      'api::quote-info.quote-info',
      'oneToOne',
      'api::image.image'
    >;
    droneUses: Attribute.Relation<
      'api::quote-info.quote-info',
      'oneToMany',
      'api::drone-use.drone-use'
    >;
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    serviceDetails: Attribute.Relation<
      'api::service.service',
      'oneToMany',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::drone-use.drone-use': ApiDroneUseDroneUse;
      'api::featured-project.featured-project': ApiFeaturedProjectFeaturedProject;
      'api::image.image': ApiImageImage;
      'api::philosophy-and-mission.philosophy-and-mission': ApiPhilosophyAndMissionPhilosophyAndMission;
      'api::project.project': ApiProjectProject;
      'api::quote-info.quote-info': ApiQuoteInfoQuoteInfo;
